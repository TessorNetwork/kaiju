...
xcod_q bonds current-reserve "$BOND_DID"
echo "Available reserve..."
xcod_q bonds available-reserve "$BOND_DID"
echo "Withdrawing 400000res using the controller DID..."
xcod_tx bonds withdraw-reserve "$BOND_DID" 400000res "$FRANCESCO_DID_FULL"
echo "Reserve withdraw account..."
xcod_q bank balances "$RESERVE_OUT"
echo "Current reserve..."
xcod_q bonds current-reserve "$BOND_DID"
echo "Available reserve..."
xcod_q bonds available-reserve "$BOND_DID"
...
xcod_tx bonds withdraw-reserve "$BOND_DID" 5000res "$FRANCESCO_DID_FULL"
echo "Cannot withdraw 595001res due to insufficient funds..."
xcod_tx bonds withdraw-reserve "$BOND_DID" 595001res "$FRANCESCO_DID_FULL"
echo "Reserve withdraw account..."
xcod_q bank balances "$RESERVE_OUT"
echo "Current reserve..."
xcod_q bonds current-reserve "$BOND_DID"
