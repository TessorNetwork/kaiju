...
kaijud_tx bonds buy 20000abc 100000res "$BOND_DID" "$MIGUEL_DID_FULL" 
echo "Miguel's account..."
kaijud_q bank balances "$MIGUEL_ADDR"

echo "Francesco buys 20000abc..."
kaijud_tx bonds buy 20000abc 100000res "$BOND_DID" "$FRANCESCO_DID_FULL" 
echo "Francesco's account..."
kaijud_q bank balances "$FRANCESCO_ADDR"

echo "Shaun cannot buy 10001abc..."
kaijud_tx bonds buy 10001abc 100000res "$BOND_DID" "$SHAUN_DID_FULL" 
echo "Shaun cannot sell anything..."
kaijud_tx bonds sell 10000abc "$BOND_DID" "$SHAUN_DID_FULL" 
echo "Shaun can buy 10000abc..."
kaijud_tx bonds buy 10000abc 100000res "$BOND_DID" "$SHAUN_DID_FULL" 
...
kaijud_tx bonds sell 20000abc "$BOND_DID" "$MIGUEL_DID_FULL" 
echo "Miguel's account..."
kaijud_q bank balances "$MIGUEL_ADDR"
