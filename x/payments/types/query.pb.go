...
func init() {
	proto.RegisterType((*QueryPaymentTemplateRequest)(nil), "xco.payments.v1.QueryPaymentTemplateRequest")
	proto.RegisterType((*QueryPaymentTemplateResponse)(nil), "xco.payments.v1.QueryPaymentTemplateResponse")
	proto.RegisterType((*QueryPaymentContractRequest)(nil), "xco.payments.v1.QueryPaymentContractRequest")
	proto.RegisterType((*QueryPaymentContractResponse)(nil), "xco.payments.v1.QueryPaymentContractResponse")
	proto.RegisterType((*QueryPaymentContractsByIdPrefixRequest)(nil), "xco.payments.v1.QueryPaymentContractsByIdPrefixRequest")
	proto.RegisterType((*QueryPaymentContractsByIdPrefixResponse)(nil), "xco.payments.v1.QueryPaymentContractsByIdPrefixResponse")
	proto.RegisterType((*QuerySubscriptionRequest)(nil), "xco.payments.v1.QuerySubscriptionRequest")
	proto.RegisterType((*QuerySubscriptionResponse)(nil), "xco.payments.v1.QuerySubscriptionResponse")
}

func init() { proto.RegisterFile("xco/payments/v1/query.proto", fileDescriptor_95b7437f261afd68) }
...
func (c *queryClient) PaymentTemplate(ctx context.Context, in *QueryPaymentTemplateRequest, opts ...grpc.CallOption) (*QueryPaymentTemplateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.payments.v1.Query/PaymentTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PaymentContract(ctx context.Context, in *QueryPaymentContractRequest, opts ...grpc.CallOption) (*QueryPaymentContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.payments.v1.Query/PaymentContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PaymentContractsByIdPrefix(ctx context.Context, in *QueryPaymentContractsByIdPrefixRequest, opts ...grpc.CallOption) (*QueryPaymentContractsByIdPrefixResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.payments.v1.Query/PaymentContractsByIdPrefix", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Subscription(ctx context.Context, in *QuerySubscriptionRequest, opts ...grpc.CallOption) (*QuerySubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.payments.v1.Query/Subscription", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_PaymentTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.payments.v1.Query/PaymentTemplate",
	}
...
func _Query_PaymentContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.payments.v1.Query/PaymentContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PaymentContractsByIdPrefix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.payments.v1.Query/PaymentContractsByIdPrefix",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Subscription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.payments.v1.Query/Subscription",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xco.payments.v1.Query",
	...
	Metadata: "xco/payments/v1/query.proto",
}
