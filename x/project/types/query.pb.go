...
// source: xco/project/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryProjectDocRequest)(nil), "xco.project.v1.QueryProjectDocRequest")
	proto.RegisterType((*QueryProjectDocResponse)(nil), "xco.project.v1.QueryProjectDocResponse")
	proto.RegisterType((*QueryProjectAccountsRequest)(nil), "xco.project.v1.QueryProjectAccountsRequest")
	proto.RegisterType((*QueryProjectAccountsResponse)(nil), "xco.project.v1.QueryProjectAccountsResponse")
	proto.RegisterType((*QueryProjectTxRequest)(nil), "xco.project.v1.QueryProjectTxRequest")
	proto.RegisterType((*QueryProjectTxResponse)(nil), "xco.project.v1.QueryProjectTxResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "xco.project.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "xco.project.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("xco/project/v1/query.proto", fileDescriptor_97c3a1719fec502e) }
...
func (c *queryClient) ProjectDoc(ctx context.Context, in *QueryProjectDocRequest, opts ...grpc.CallOption) (*QueryProjectDocResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.project.v1.Query/ProjectDoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ProjectAccounts(ctx context.Context, in *QueryProjectAccountsRequest, opts ...grpc.CallOption) (*QueryProjectAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.project.v1.Query/ProjectAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ProjectTx(ctx context.Context, in *QueryProjectTxRequest, opts ...grpc.CallOption) (*QueryProjectTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.project.v1.Query/ProjectTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.project.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ProjectDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.project.v1.Query/ProjectDoc",
	}
...
func _Query_ProjectAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.project.v1.Query/ProjectAccounts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ProjectTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.project.v1.Query/ProjectTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.project.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xco.project.v1.Query",
	...
	Metadata: "xco/project/v1/query.proto",
}
