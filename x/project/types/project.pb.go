...
// source: xco/project/v1/project.proto
...
type CreateAgentDoc struct {
	AgentDid github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=agent_did,json=agentDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"did" yaml:"did"`
...
func (m *CreateAgentDoc) GetAgentDid() github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.AgentDid
	}
	return ""
...
type WithdrawFundsDoc struct {
	...
	RecipientDid github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=recipient_did,json=recipientDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"recipientDid" yaml:"recipientDid"`
...
func (m *WithdrawFundsDoc) GetRecipientDid() github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
...
type ProjectDoc struct {
	...
	SenderDid  github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,3,opt,name=sender_did,json=senderDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"senderDid" yaml:"senderDid"`
...
func (m *ProjectDoc) GetSenderDid() github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.SenderDid
	}
	return ""
...
func (m *WithdrawalInfoDoc) GetRecipientDid() github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.RecipientDid
	}
	return ""
...
type Params struct {
	XcoDid                       string                                   `protobuf:"bytes,1,opt,name=xco_did,json=xcoDid,proto3" json:"xco_did,omitempty" yaml:"xco_did"`
...
type Claim struct {
	...
	ClaimerDid github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,3,opt,name=claimer_did,json=claimerDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"claimer_did,omitempty" yaml:"claimer_did"`
...
func (m *Claim) GetClaimerDid() github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.ClaimerDid
	}
	return ""
...
func init() {
	proto.RegisterType((*UpdateProjectStatusDoc)(nil), "xco.project.v1.UpdateProjectStatusDoc")
	proto.RegisterType((*CreateAgentDoc)(nil), "xco.project.v1.CreateAgentDoc")
	proto.RegisterType((*UpdateAgentDoc)(nil), "xco.project.v1.UpdateAgentDoc")
	proto.RegisterType((*CreateClaimDoc)(nil), "xco.project.v1.CreateClaimDoc")
	proto.RegisterType((*CreateEvaluationDoc)(nil), "xco.project.v1.CreateEvaluationDoc")
	proto.RegisterType((*WithdrawFundsDoc)(nil), "xco.project.v1.WithdrawFundsDoc")
	proto.RegisterType((*ProjectDoc)(nil), "xco.project.v1.ProjectDoc")
	proto.RegisterType((*WithdrawalInfoDoc)(nil), "xco.project.v1.WithdrawalInfoDoc")
	proto.RegisterType((*Params)(nil), "xco.project.v1.Params")
	proto.RegisterType((*Claim)(nil), "xco.project.v1.Claim")
	proto.RegisterType((*GenesisAccountMap)(nil), "xco.project.v1.GenesisAccountMap")
	proto.RegisterMapType((map[string]string)(nil), "xco.project.v1.GenesisAccountMap.MapEntry")
	proto.RegisterType((*AccountMap)(nil), "xco.project.v1.AccountMap")
	proto.RegisterMapType((map[string]string)(nil), "xco.project.v1.AccountMap.MapEntry")
	proto.RegisterType((*WithdrawalInfoDocs)(nil), "xco.project.v1.WithdrawalInfoDocs")
	proto.RegisterType((*Claims)(nil), "xco.project.v1.Claims")
}

func init() { proto.RegisterFile("xco/project/v1/project.proto", fileDescriptor_1fcfbd691efecbfd) }
...
func (m *CreateAgentDoc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AgentDid = github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *WithdrawFundsDoc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.RecipientDid = github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *ProjectDoc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.SenderDid = github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *Claim) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.ClaimerDid = github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Status", wireType)
