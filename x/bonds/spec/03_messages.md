...
|:-------------------------|:-----------------|:----------------|
| BondDid                  | `did.Did`        | DID of the bond (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| CreatorDid               | `did.Did`        | DID of the bond creator (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
| ControllerDid            | `did.Did`        | DID of the bond controller (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field**              | **Type**  | **Description** |
|:-----------------------|:----------|:----------------|
| BondDid                | `did.Did` | DID of the bond we are interacting with (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| EditorDid              | `did.Did` | DID of the bond editor (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field** | **Type**    | **Description** |
|:----------|:------------|:----------------|
| BuyerDid  | `did.Did`   | DID of the buyer (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field** | **Type**   | **Description** |
|:----------|:-----------|:----------------|
| SellerDid | `did.Did`  | DID of the seller (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field**  | **Type**   | **Description** |
|:-----------|:-----------|:----------------|
| SwapperDid | `did.Did`  | DID of the swapper (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
| BondDid    | `did.Did`  | DID of the bond we are interacting with (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field** | **Type**  | **Description** |
|:----------|:----------|:----------------|
| SenderDid | `did.Did` | DID of the sender (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field**    | **Type**  | **Description** |
|:-------------|:----------|:----------------|
| RecipientDid | `did.Did` | DID of the recipient (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
| BondDid      | `did.Did` | DID of the bond we are interacting with (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
...
| **Field**     | **Type**    | **Description** |
|:--------------|:------------|:----------------|
| WithdrawerDid | `did.Did`   | DID of the withdrawer (e.g. `did:kaiju:U7GK8p8rVhJMKhBVRCJJ8c`)
