...
var (
	pattern_Query_Bonds_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"xco", "bonds"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BondsDetailed_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"xco", "bonds_detailed"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"xco", "bonds", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Bond_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"xco", "bonds", "bond_did"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Batch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"xco", "bonds", "bond_did", "batch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LastBatch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"xco", "bonds", "bond_did", "last_batch"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CurrentPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"xco", "bonds", "bond_did", "current_price"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CurrentReserve_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"xco", "bonds", "bond_did", "current_reserve"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AvailableReserve_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"xco", "bonds", "bond_did", "available_reserve"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_CustomPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"xco", "bonds", "bond_did", "price", "bond_amount"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BuyPrice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"xco", "bonds", "bond_did", "buy_price", "bond_amount"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SellReturn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"xco", "bonds", "bond_did", "sell_return", "bond_amount"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SwapReturn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"xco", "bonds", "bond_did", "swap_return", "from_token_with_amount", "to_token"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AlphaMaximums_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"xco", "bonds", "bond_did", "alpha_maximums"}, "", runtime.AssumeColonVerbOpt(false)))
)
