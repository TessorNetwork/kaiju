...
type Bond struct {
	...
	CreatorDid                   github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=creator_did,json=creatorDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"creator_did,omitempty" yaml:"creator_did"`
	ControllerDid                github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,5,opt,name=controller_did,json=controllerDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"controller_did,omitempty" yaml:"controller_did"`
	...
	OracleDid                    github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,28,opt,name=oracle_did,json=oracleDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"oracle_did,omitempty" yaml:"oracle_did"`
}
...
func (m *Bond) GetCreatorDid() github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *Bond) GetControllerDid() github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment {
	if m != nil {
...
func (m *Bond) GetOracleDid() github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.OracleDid
	}
	return ""
...
type BaseOrder struct {
	AccountDid   github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=account_did,json=accountDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"account_did,omitempty" yaml:"account_did"`
...
func (m *BaseOrder) GetAccountDid() github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.AccountDid
	}
	return ""
...
func init() { proto.RegisterFile("kaiju/bonds/v1beta1/bonds.proto", fileDescriptor_93b4137e78081347) }
...
func (m *Bond) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.ControllerDid = github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
		...
		case 28:
			...
			m.OracleDid = github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBonds(dAtA[iNdEx:])
...
func (m *BaseOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AccountDid = github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
