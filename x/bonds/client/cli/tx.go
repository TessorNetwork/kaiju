...
func NewCmdCreateBond() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			// Parse creator's kaiju DID
			creatorDid, err := didtypes.UnmarshalKaijuDid(_creatorDid)
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), creatorDid, msg)
		},
	}
...
func NewCmdEditBond() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse editor's kaiju DID
			editorDid, err := didtypes.UnmarshalKaijuDid(_editorDid)
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), editorDid, msg)
		},
	}
...
func NewCmdSetNextAlpha() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "set-next-alpha 0.5 U7GK8p8rVhJMKhBVRCJJ8c <editor-kaiju-did>",
...
func NewCmdUpdateBondState() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "update-bond-state SETTLE U7GK8p8rVhJMKhBVRCJJ8c <editor-kaiju-did>",
...
func NewCmdBuy() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "" +
			"buy 10abc 1000res1 U7GK8p8rVhJMKhBVRCJJ8c <buyer-kaiju-did>\n" +
			"buy 10abc 1000res1,1000res2 U7GK8p8rVhJMKhBVRCJJ8c <buyer-kaiju-did>",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse buyer's kaiju DID
			buyerDid, err := didtypes.UnmarshalKaijuDid(args[3])
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), buyerDid, msg)
		},
	}
...
func NewCmdSell() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "sell 10abc U7GK8p8rVhJMKhBVRCJJ8c <seller-kaiju-did>",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse seller's kaiju DID
			sellerDid, err := didtypes.UnmarshalKaijuDid(args[2])
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), sellerDid, msg)
		},
	}
...
func NewCmdSwap() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "" +
			"swap 100 res1 res2 U7GK8p8rVhJMKhBVRCJJ8c <swapper-kaiju-did>\n" +
			"swap 100 res2 res1 U7GK8p8rVhJMKhBVRCJJ8c <swapper-kaiju-did>",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse swapper's kaiju DID
			swapperDid, err := didtypes.UnmarshalKaijuDid(args[4])
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), swapperDid, msg)
		},
	}
...
func NewCmdMakeOutcomePayment() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "make-outcome-payment U7GK8p8rVhJMKhBVRCJJ8c 100 <sender-kaiju-did>",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse sender's kaiju DID
			sender, err := didtypes.UnmarshalKaijuDid(args[2])
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), sender, msg)
		},
	}
...
func NewCmdWithdrawShare() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "withdraw-share U7GK8p8rVhJMKhBVRCJJ8c <recipient-kaiju-did>",
		Short:   "Withdraw share from a bond that is in settlement state",
		Args:    cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {

			// Parse recipient's kaiju DID
			recipientDid, err := didtypes.UnmarshalKaijuDid(args[1])
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), recipientDid, msg)
		},
	}
...
func NewCmdWithdrawReserve() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "withdraw-reserve U7GK8p8rVhJMKhBVRCJJ8c 1000res <withdrawer-kaiju-did>",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Parse withdrawer's kaiju DID
			withdrawerDid, err := didtypes.UnmarshalKaijuDid(args[2])
			if err != nil {
				return err
			}
			...
			return kaijutypes.GenerateOrBroadcastTxCLI(cliCtx, cmd.Flags(), withdrawerDid, msg)
		},
	}
