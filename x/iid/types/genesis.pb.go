...
// source: xco/iid/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "xco.iid.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("xco/iid/v1beta1/genesis.proto", fileDescriptor_da4523a0526d3e8e) }
