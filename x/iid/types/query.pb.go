...
func init() {
	proto.RegisterType((*QueryIidDocumentsRequest)(nil), "xco.iid.v1beta1.QueryIidDocumentsRequest")
	proto.RegisterType((*QueryIidDocumentsResponse)(nil), "xco.iid.v1beta1.QueryIidDocumentsResponse")
	proto.RegisterType((*QueryIidDocumentRequest)(nil), "xco.iid.v1beta1.QueryIidDocumentRequest")
	proto.RegisterType((*QueryIidDocumentResponse)(nil), "xco.iid.v1beta1.QueryIidDocumentResponse")
	proto.RegisterType((*QueryIidMetaDataRequest)(nil), "xco.iid.v1beta1.QueryIidMetaDataRequest")
	proto.RegisterType((*QueryIidMetaDataResponse)(nil), "xco.iid.v1beta1.QueryIidMetaDataResponse")
}

func init() { proto.RegisterFile("xco/iid/v1beta1/query.proto", fileDescriptor_4950ee37c7844ad4) }
...
func (c *queryClient) IidDocuments(ctx context.Context, in *QueryIidDocumentsRequest, opts ...grpc.CallOption) (*QueryIidDocumentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.iid.v1beta1.Query/IidDocuments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) IidDocument(ctx context.Context, in *QueryIidDocumentRequest, opts ...grpc.CallOption) (*QueryIidDocumentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.iid.v1beta1.Query/IidDocument", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) MetaData(ctx context.Context, in *QueryIidMetaDataRequest, opts ...grpc.CallOption) (*QueryIidMetaDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.iid.v1beta1.Query/MetaData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_IidDocuments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.iid.v1beta1.Query/IidDocuments",
	}
...
func _Query_IidDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.iid.v1beta1.Query/IidDocument",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_MetaData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.iid.v1beta1.Query/MetaData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xco.iid.v1beta1.Query",
	...
	Metadata: "xco/iid/v1beta1/query.proto",
}
