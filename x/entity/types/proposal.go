...
import (
	...
	types "github.com/tessornetwork/kaiju/x/iid/types"
)
...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&InitializeNftContract{}, "entity.kaiju.entity.v1beta1.InitializeNftContract")
}
