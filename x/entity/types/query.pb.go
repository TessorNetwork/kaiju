...
func init() {
	proto.RegisterType((*QueryEntityListRequest)(nil), "xco.entity.v1beta1.QueryEntityListRequest")
	proto.RegisterType((*QueryEntityListResponse)(nil), "xco.entity.v1beta1.QueryEntityListResponse")
	proto.RegisterType((*QueryEntityDocRequest)(nil), "xco.entity.v1beta1.QueryEntityDocRequest")
	proto.RegisterType((*QueryEntityDocResponse)(nil), "xco.entity.v1beta1.QueryEntityDocResponse")
	proto.RegisterType((*QueryEntityConfigRequest)(nil), "xco.entity.v1beta1.QueryEntityConfigRequest")
	proto.RegisterType((*QueryEntityConfigResponse)(nil), "xco.entity.v1beta1.QueryEntityConfigResponse")
	proto.RegisterMapType((map[string]string)(nil), "xco.entity.v1beta1.QueryEntityConfigResponse.MapEntry")
}

func init() { proto.RegisterFile("xco/entity/v1beta1/query.proto", fileDescriptor_45d5ce4a4abd6232) }
...
func (c *queryClient) EntityList(ctx context.Context, in *QueryEntityListRequest, opts ...grpc.CallOption) (*QueryEntityListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.entity.v1beta1.Query/EntityList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EntityDoc(ctx context.Context, in *QueryEntityDocRequest, opts ...grpc.CallOption) (*QueryEntityDocResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.entity.v1beta1.Query/EntityDoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EntityConfig(ctx context.Context, in *QueryEntityConfigRequest, opts ...grpc.CallOption) (*QueryEntityConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.entity.v1beta1.Query/EntityConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EntityList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.entity.v1beta1.Query/EntityList",
	}
...
func _Query_EntityDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.entity.v1beta1.Query/EntityDoc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_EntityConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.entity.v1beta1.Query/EntityConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xco.entity.v1beta1.Query",
	...
	Metadata: "xco/entity/v1beta1/query.proto",
}
