...
type MsgCreateEntity struct {
	...
	OwnerDid             github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,17,opt,name=ownerDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"owner_did" yaml:"owner_did"`
...
type MsgUpdateEntity struct {
	...
	ControllerDid        github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,8,opt,name=controllerDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"controller_did" yaml:"controller_did"`
...
type MsgTransferEntity struct {
	...
	OwnerDid     github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=ownerDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"owner_did" yaml:"owner_did"`
	OwnerAddress string                                                          `protobuf:"bytes,3,opt,name=ownerAddress,proto3" json:"owner_address" yaml:"owner_address"`
	RecipientDid github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=recipientDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"recipient_did" yaml:"recipient_did"`
}
...
func init() { proto.RegisterFile("kaiju/entity/v1beta1/tx.proto", fileDescriptor_60859df4ac9fa053) }
...
func (m *MsgCreateEntity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			...
			m.OwnerDid = github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
