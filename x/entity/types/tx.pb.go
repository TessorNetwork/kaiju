...
// source: xco/entity/v1beta1/tx.proto
...
type MsgCreateEntity struct {
	...
	OwnerDid             github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,17,opt,name=ownerDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"owner_did" yaml:"owner_did"`
...
type MsgUpdateEntity struct {
	...
	ControllerDid        github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,8,opt,name=controllerDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"controller_did" yaml:"controller_did"`
...
type MsgTransferEntity struct {
	...
	OwnerDid     github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=ownerDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"owner_did" yaml:"owner_did"`
	OwnerAddress string                                                          `protobuf:"bytes,3,opt,name=ownerAddress,proto3" json:"owner_address" yaml:"owner_address"`
	RecipientDid github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=recipientDid,proto3,casttype=github.com/petrinetwork/xco-blockchain/x/iid/types.DIDFragment" json:"recipient_did" yaml:"recipient_did"`
}
...
func init() {
	proto.RegisterType((*MsgCreateEntity)(nil), "xco.entity.v1beta1.MsgCreateEntity")
	proto.RegisterType((*MsgCreateEntityResponse)(nil), "xco.entity.v1beta1.MsgCreateEntityResponse")
	proto.RegisterType((*MsgUpdateEntity)(nil), "xco.entity.v1beta1.MsgUpdateEntity")
	proto.RegisterType((*MsgUpdateEntityResponse)(nil), "xco.entity.v1beta1.MsgUpdateEntityResponse")
	proto.RegisterType((*MsgTransferEntity)(nil), "xco.entity.v1beta1.MsgTransferEntity")
	proto.RegisterType((*MsgTransferEntityResponse)(nil), "xco.entity.v1beta1.MsgTransferEntityResponse")
}

func init() { proto.RegisterFile("xco/entity/v1beta1/tx.proto", fileDescriptor_60859df4ac9fa053) }
...
func (c *msgClient) CreateEntity(ctx context.Context, in *MsgCreateEntity, opts ...grpc.CallOption) (*MsgCreateEntityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.entity.v1beta1.Msg/CreateEntity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateEntity(ctx context.Context, in *MsgUpdateEntity, opts ...grpc.CallOption) (*MsgUpdateEntityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.entity.v1beta1.Msg/UpdateEntity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) TransferEntity(ctx context.Context, in *MsgTransferEntity, opts ...grpc.CallOption) (*MsgTransferEntityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.entity.v1beta1.Msg/TransferEntity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.entity.v1beta1.Msg/CreateEntity",
	}
...
func _Msg_UpdateEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.entity.v1beta1.Msg/UpdateEntity",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_TransferEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.entity.v1beta1.Msg/TransferEntity",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xco.entity.v1beta1.Msg",
	...
	Metadata: "xco/entity/v1beta1/tx.proto",
}
...
func (m *MsgCreateEntity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			...
			m.OwnerDid = github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
