...
func init() {
	proto.RegisterType((*QueryTokenListRequest)(nil), "xco.token.v1beta1.QueryTokenListRequest")
	proto.RegisterType((*QueryTokenListResponse)(nil), "xco.token.v1beta1.QueryTokenListResponse")
	proto.RegisterType((*QueryTokenDocRequest)(nil), "xco.token.v1beta1.QueryTokenDocRequest")
	proto.RegisterType((*QueryTokenDocResponse)(nil), "xco.token.v1beta1.QueryTokenDocResponse")
	proto.RegisterType((*QueryTokenConfigRequest)(nil), "xco.token.v1beta1.QueryTokenConfigRequest")
	proto.RegisterType((*QueryTokenConfigResponse)(nil), "xco.token.v1beta1.QueryTokenConfigResponse")
	proto.RegisterMapType((map[string]string)(nil), "xco.token.v1beta1.QueryTokenConfigResponse.MapEntry")
}

func init() { proto.RegisterFile("xco/token/v1beta1/query.proto", fileDescriptor_ce478daca359f034) }
...
func (c *queryClient) TokenList(ctx context.Context, in *QueryTokenListRequest, opts ...grpc.CallOption) (*QueryTokenListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.token.v1beta1.Query/TokenList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenDoc(ctx context.Context, in *QueryTokenDocRequest, opts ...grpc.CallOption) (*QueryTokenDocResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.token.v1beta1.Query/TokenDoc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenConfig(ctx context.Context, in *QueryTokenConfigRequest, opts ...grpc.CallOption) (*QueryTokenConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/xco.token.v1beta1.Query/TokenConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TokenList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.token.v1beta1.Query/TokenList",
	}
...
func _Query_TokenDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.token.v1beta1.Query/TokenDoc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TokenConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xco.token.v1beta1.Query/TokenConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "xco.token.v1beta1.Query",
	...
	Metadata: "xco/token/v1beta1/query.proto",
}
