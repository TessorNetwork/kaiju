...
func NewMintAuthorization(minterDid iidtypes.DIDFragment, cw20Limit, cw721Limit, kaiju1155Limit int64) *MintAuthorization {
	return &MintAuthorization{
		MinterDid: minterDid,
		// MintLimit: &MintLimit{
		// 	Cw20:    string(cw20Limit),
		// 	Cw721:   string(cw721Limit),
		// 	Kaiju1155: string(kaiju1155Limit),
		// },
	}
}
...
func (a MintAuthorization) Accept(ctx sdk.Context, msg sdk.Msg) (authz.AcceptResponse, error) {
	...
	// if a.MintLimit.Cw20 == 0 && a.MintLimit.Cw721 == 0 && a.MintLimit.Kaiju1155 == 0 {
