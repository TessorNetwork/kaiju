...
// source: xco/token/v1beta1/token.proto
...
type TokenMinter struct {
	...
	ContractType    ContractType                                                    `protobuf:"varint,4,opt,name=contractType,proto3,enum=xco.token.v1beta1.ContractType" json:"contract_type" yaml:"contract_type"`
...
func init() {
	proto.RegisterEnum("xco.token.v1beta1.ContractType", ContractType_name, ContractType_value)
	proto.RegisterType((*Contract)(nil), "xco.token.v1beta1.Contract")
	proto.RegisterType((*Params)(nil), "xco.token.v1beta1.Params")
	proto.RegisterType((*TokenMinter)(nil), "xco.token.v1beta1.TokenMinter")
}

func init() { proto.RegisterFile("xco/token/v1beta1/token.proto", fileDescriptor_5772c07022bd1ddf) }
