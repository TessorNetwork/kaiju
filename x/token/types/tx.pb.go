...
type MsgSetupMinter struct {
	MinterDid     github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=minterDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"minter_did" yaml:"minter_did"`
...
type MsgMint struct {
	...
	OwnerDid        github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=ownerDid,proto3,casttype=github.com/tessornetwork/kaiju/x/iid/types.DIDFragment" json:"minter_did" yaml:"minter_did"`
...
func init() { proto.RegisterFile("kaiju/token/v1beta1/tx.proto", fileDescriptor_bb958a4ae6c01cf1) }
...
func (m *MsgSetupMinter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.MinterDid = github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
