...
func (m *MintAuthorization) GetMinterDid() github_com_kaijufoundation_kaiju_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.MinterDid
	}
	return ""
...
func init() { proto.RegisterFile("kaiju/token/v1beta1/authz.proto", fileDescriptor_cca6ff8f08fc36db) }
