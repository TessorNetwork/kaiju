...
// source: xco/token/v1beta1/authz.proto
...
func (m *MintAuthorization) GetMinterDid() github_com_xcofoundation_xco_blockchain_x_iid_types.DIDFragment {
	if m != nil {
		return m.MinterDid
	}
	return ""
...
func init() {
	proto.RegisterType((*Cw20Constraints)(nil), "xco.token.v1beta1.Cw20Constraints")
	proto.RegisterType((*Cw721Constraints)(nil), "xco.token.v1beta1.Cw721Constraints")
	proto.RegisterType((*Cw1155Constraints)(nil), "xco.token.v1beta1.Cw1155Constraints")
	proto.RegisterType((*MintConstraints)(nil), "xco.token.v1beta1.MintConstraints")
	proto.RegisterType((*MintAuthorization)(nil), "xco.token.v1beta1.MintAuthorization")
}

func init() { proto.RegisterFile("xco/token/v1beta1/authz.proto", fileDescriptor_cca6ff8f08fc36db) }
