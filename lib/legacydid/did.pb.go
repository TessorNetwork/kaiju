...
// source: xco/legacy/did/did.proto
...
// An xco DID with public and private keys, based on the Sovrin DID spec
type XcoDid struct {
...
func (m *XcoDid) Reset()         { *m = XcoDid{} }
func (m *XcoDid) String() string { return proto.CompactTextString(m) }
func (*XcoDid) ProtoMessage()    {}
func (*XcoDid) Descriptor() ([]byte, []int) {
	return fileDescriptor_515f25a9bd100c9a, []int{2}
}
func (m *XcoDid) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *XcoDid) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_XcoDid.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *XcoDid) XXX_Merge(src proto.Message) {
	xxx_messageInfo_XcoDid.Merge(m, src)
}
func (m *XcoDid) XXX_Size() int {
	return m.Size()
}
func (m *XcoDid) XXX_DiscardUnknown() {
	xxx_messageInfo_XcoDid.DiscardUnknown(m)
}

var xxx_messageInfo_XcoDid proto.InternalMessageInfo

func (m *XcoDid) GetDid() string {
	if m != nil {
		return m.Did
	}
	return ""
...
func (m *XcoDid) GetVerifyKey() string {
	if m != nil {
		return m.VerifyKey
	}
	return ""
...
func (m *XcoDid) GetEncryptionPublicKey() string {
	if m != nil {
...
func (m *XcoDid) GetSecret() *Secret {
	if m != nil {
		return m.Secret
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*XcoDid)(nil), "legacydid.XcoDid")
	proto.RegisterType((*Secret)(nil), "legacydid.Secret")
}

func init() { proto.RegisterFile("xco/legacy/did/did.proto", fileDescriptor_515f25a9bd100c9a) }
...
func (m *XcoDid) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *XcoDid) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *XcoDid) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *XcoDid) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: XcoDid: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: XcoDid: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
