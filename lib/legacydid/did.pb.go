...
func (*DidCredential) Descriptor() ([]byte, []int) {
	return fileDescriptor_a496717d0884e882, []int{0}
}
...
func (*Claim) Descriptor() ([]byte, []int) {
	return fileDescriptor_a496717d0884e882, []int{1}
}
...
func (*KaijuDid) Descriptor() ([]byte, []int) {
	return fileDescriptor_a496717d0884e882, []int{2}
}
...
func (*Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_a496717d0884e882, []int{3}
}
...
func init() { proto.RegisterFile("kaiju/legacy/did/did.proto", fileDescriptor_a496717d0884e882) }

var fileDescriptor_a496717d0884e882 = []byte{
	// 550 bytes of a gzipped FileDescriptorProto
	,
}
