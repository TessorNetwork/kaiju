...
func sign(txf tx.Factory, clientCtx client.Context, txBuilder client.TxBuilder, overwriteSig bool, kaijuDid didtypes.KaijuDid) error {
...
func makeSignCmd() func(cmd *cobra.Command, args []string) error {
	return func(cmd *cobra.Command, args []string) (err error) {
		...
		singerDid, err := didtypes.UnmarshalKaijuDid(args[0])
		if err != nil {
			return err
		}
